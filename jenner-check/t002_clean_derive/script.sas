...
/* --- author's cleaned dataset with derived per-learner ratios + Size band --- */
title 'Dataset After Data Cleaning';
proc print data=work.cleaned label;
run;

title 'Variable Information';
proc contents data=work.cleaned;
run;
