...
/* --- author's PROC TABULATE relating Institute_Type and Size --- */
title1 'Analysis on Total_Glh_per_learner by Institute_Type and Size';
proc tabulate data=work.modified;
    class Institute_Type Size;
    var Total_Glh_per_learner;
    table (Total_Glh_per_learner) * Institute_Type * Size
          , (n nmiss min q1 median q3 max mean std);
run;

/* --- and the author's region/year TABULATE of the per-year ratios --- */
